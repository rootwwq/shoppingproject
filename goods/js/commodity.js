                ...
                html += `<li class="item">
                    <div class="goods-content" goods-item="" data-storage="10" data-goods-id="34661" data-common-id="33163"
                        ...
                        <div class="promotion_text">
                            ...
                            <div class="floating_layer" style="z-index:999;top:225px;height:80px ">
                                 <a class="buy" href="javascript:;" nc-add-cart="">
...
function add() {
    let addObj = document.querySelectorAll('.promotion_text');
    let pObj = document.querySelectorAll('.floating_layer');
    let btnObj = document.querySelectorAll('.buy');
    // console.log(btnObj);
    // console.log(pObj);

    for (let i = 0; i < addObj.length; i++) {
        addObj[i].onmouseover = function () {
            pObj[i].style.position = 'absolute';
            cartkey(btnObj, i);
        }
        addObj[i].onmouseout = function () {
            pObj[i].style.position = 'static';
        }
    }
